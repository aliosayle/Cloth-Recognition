...
# Train the model
loaded_model = model.fit(train_images, train_labels, epochs=100)
...
#loaded_model = keras.models.load_model('/Users/aliossaily/Documents/MNIST-fashion-image-detection')

# Load the test image
test_image_path = '/Users/aliossaily/Desktop/MNIST-fashion-image-detection/20230707_170128.jpg'  # Provide the path to your test image
